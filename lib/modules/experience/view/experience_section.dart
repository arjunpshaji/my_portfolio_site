      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text("Experience", style: TextStyle(fontSize: 65, color: appColor(context)?.primaryText, fontFamily: 'Caveat')),
          ),
          GlowingContainer(
            ...
            child: Column(
              ...
              spacing: 12,
              children: [
                Text("Techfriar (2022 - 2025)", style: TextStyle(fontSize: 32, fontWeight: FontWeight.w700, color: appColor(context)?.primaryText)),
                Text(
          ...
          GlowingContainer(
            ...
            child: Column(
              ...
              spacing: 12,
              children: [
                Text("Freelance", style: TextStyle(fontSize: 32, fontWeight: FontWeight.w700, color: appColor(context)?.primaryText)),
                Text(
